...
router.get(
  '/get-bars/:ticker',
   async (req, res, next) => {
    const resp = alpaca.getBarsV2(req.params.ticker, {
...
router.get(
  '/get-trades/intraday/:date/:ticker',
   async (req, res, next) => {
    const resp = alpaca.getTradesV2(req.params.ticker, {
